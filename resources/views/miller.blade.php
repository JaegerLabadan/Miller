        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-6" style="padding-top: 29px;">
                    <div class="lift">
                    <img src="images/lads.png" style="height: auto; width: 100%;">
                    </div>
                </div>
                <div class="col-sm-6" style="padding-top: 190px;">
                    <div class="right">
                    <h1 class="heading1">Your Perfect Venue</h1>
...
<section class="sec2 padtop">
	<div class="container">
		<div class="col-sm-12">
			<div class="row kini">
				<div class="col-sm-4">
					<img src="images/icon1.png" height="100" width="100">
					<p class="itim">We Create <br> your Perfect venue<br> for promoting<br> your brand</p>
				</div>
				<div class="col-sm-4">
					<img src="images/icon2.png" height="100" width="100">
					<p class="itim">22+ yrs experience <br> helping hobbyists <br> turn their passion <br> to profitable business</p>
				</div>
				<div class="col-sm-4">
					<img src="images/icon3.png" height="100" width="100">
					<p class="itim">Engage w/ your <br> customers & build a <br> strong & successful <br> business relationship</p>
				</div>
			</div>
		</div>
	</div>
...
<section class="section2 blu2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                <img class="imahe" src="images/kil.png">
            </div>
        </div>
    </div> 
</section>
