            ...
            <div class="footer_widget_area">
                <div class="container">
                   <section class="customer-logos slider">
                      <div class="slide"><img src="{{ asset('images/square.png') }}" ></div>
                      <div class="slide"><img src="{{ asset('images/book.png') }}"></div>
                      <div class="slide"><img src="{{ asset('images/wsba.png') }}"></div>
                      <div class="slide"><img src="{{ asset('images/ins.png') }}"></div>
                      <div class="slide"><img src="{{ asset('images/square.png') }}" ></div>
                      <div class="slide"><img src="{{ asset('images/book.png') }}"></div>
                      <div class="slide"><img src="{{ asset("images/wsba.png") }}"></div>
                   </section>
